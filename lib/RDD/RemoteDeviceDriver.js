 ...
 */
  ...
  */
  open(unitName, flags, opts, callback) {
    ...
    logger.trace(`Response event to listen for: ${openEvent}`);
  ...
  read(handle, flags, reg, count, callback) {
    ...
    logger.trace(`Response event to listen for: ${readEvent}`);
 ...
 */
  close(handle, flags, callback) {
    ...
    logger.trace(`Response event to listen for: ${closeEvent}`);
